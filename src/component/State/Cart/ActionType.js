...
export const ADD_ITEM_TO_CART_BY_CODE_REQUEST = 'ADD_ITEM_TO_CART_BY_CODE_REQUEST';
export const ADD_ITEM_TO_CART_BY_CODE_SUCCESS = 'ADD_ITEM_TO_CART_BY_CODE_SUCCESS';
export const ADD_ITEM_TO_CART_BY_CODE_FAILURE = 'ADD_ITEM_TO_CART_BY_CODE_FAILURE';
